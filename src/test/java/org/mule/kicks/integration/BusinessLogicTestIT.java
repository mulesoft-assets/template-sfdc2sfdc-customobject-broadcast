...
public class BusinessLogicTestIT extends AbstractKickTestCase {
	...
	public void testMainFlow() throws Exception {
	    workingPollProber.check(new Probe() {
            ...
            public boolean isSatisfied() {
                try {
                    assertEquals("The custom object should not have been sync", null,
                    ...
                    assertEquals("The custom object should have been sync", 
                    ...
                    assertEquals("The custom object should have been sync (Name)", 
                            createdCustomObjectsInA.get(3).get("Name"),
                            payload.get("Name"));
                    assertEquals("The custom object should have been sync (interpreter__c)", 
            ...
            public String describeFailure() {
                return "custom objects were not synced";
            }
        });
	}
    ...
    private void stopSchedulers() throws MuleException
    {
        final Collection<Scheduler> schedulers = muleContext.getRegistry().lookupScheduler(
                Schedulers.flowPollingSchedulers("upsertCustomObjectFromAToB"));
	...
	@SuppressWarnings("unchecked")
	private Map<String, String> invokeRetrieveCustomObjectFlow(final SubflowInterceptingChainLifecycleWrapper flow,
			final Map<String, String> customObject) throws Exception {
